...
// They can only add and delete transactions — no reports, no BIR, no books.
// Orange accent theme to visually distinguish from Client (blue) and Accountant (teal).
        ...
        <div style={{ background: T.accentL, border: `1px solid ${T.accent}30`, borderRadius: 10,
          ...
          <div>
            ...
            <span style={{ fontSize: 13, color: T.muted, marginLeft: 8 }}>
              You can add and delete transactions. Contact your accountant for reports, BIR returns, or business settings.
            </span>
          </div>
        </div>
